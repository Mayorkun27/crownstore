...
//         try {
//             const orderResponse = await axios.post(`${API_URL}/api/order`, payload, {
//                 headers: {
...
//                 <ul className={`text-xs flex flex-col gap-1 ${!isPrinting && "max-h-[200px] overflow-y-auto"}`}>
//                     {cart.length === 0 ? (
...
//                 <div
//                 className={`py-2 ${isPrinting ? "text-[10px]" : "text-xs"} border-y border-dashed space-y-1`}
//                 >
...
//                     <div
//                     className={`pb-2 ${isPrinting ? "text-[10px]" : "text-xs"} border-b border-dashed`}
//                     >
...
//                 <div className={`receipt-bottom text-[10px] ${isPrinting && "border-b !h-[20mm]"}`}>
//                     <div
//                         className={`${isPrinting ? "flex-col" : "flex-row"} flex items-center justify-between`}
//                     >
